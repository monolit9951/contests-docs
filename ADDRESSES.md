...
Страниц: **79** · адресов: **220** · редиректов со старых адресов: **92**
...
## Адреса, которые не переезжают

Адрес остаётся живым 301-редиректом, но своей страницы или файла у него больше нет.

| Было | Ведёт на | Почему |
|---|---|---|
| `/docs/ru/kak-rabotaet/` | `/earn` | дублировал лендинг приложения «Как это работает», который переведён на три языка и остаётся в SPA |
| `/docs/sitemap.xml` | `/sitemap-content.xml` | сайтмап старого дерева `/docs/`; с 04.08.2026 его заменил `/sitemap-content.xml`, а GPTBot продолжал запрашивать старый адрес и получал 404 |
