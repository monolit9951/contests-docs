...
<template>
  <footer class="lp-footer">
    <div class="lp-container lp-footer-in">
      <div>© DareBay · <a :href="theme.darebayCta.productUrl">{{ copy.footerHome }}</a> · <a :href="theme.darebayCta.telegramUrl" target="_blank" rel="noreferrer">{{ copy.footerTelegram }}</a></div>
