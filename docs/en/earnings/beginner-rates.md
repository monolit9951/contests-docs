...
"No audience requirement" does not mean "no threshold at all". Each submission has a view threshold (**2000 views**), and it keeps the budget from being spread too thin. What does not exist is a follower threshold: a beginner competes on exactly the same terms as a veteran.

## How to start earning

1. Sign up at [DareBay](https://darebay.com), which is free
...
On platforms like the TikTok Creator Fund and the YouTube Shorts Fund, payouts are tied to audience size, geography and algorithms, so a new creator spends months building a follower base before seeing any income at all.

DareBay works the other way round: the buyer sets the rate and freezes the budget up front. There is no follower threshold. Your clip reaches **2000 views** and you get paid by the formula, whatever your follower count says.

The full mechanics, from locked budget to payout, are in [how pay-per-view works](/en/earnings/how-pay-per-view-works).

## Frequently asked questions

### Do I need followers to start?

No. There is no minimum follower count anywhere in the rules. You can start from zero. The one condition is reaching **2000 views** on a specific submission.

### What is the view threshold?

**2000 views** per submission. That is the minimum at which a submission joins the budget split. Clips below it are not paid.
...
Sign up, open the contest catalogue and pick a subject you actually know. Film to the terms of the brief and publish. Editing experience helps but is not required: plenty of clippers start with simple formats.
...
- [What DareBay pays per 1000 views](/en/earnings/pay-per-1000-views) - the range of rates across live contests
- [How much clipping pays](/en/earnings/how-much-clipping-pays) - the maths for different scenarios
- [Earning with no followers](/en/earnings/earn-without-followers) - how to start from zero followers
