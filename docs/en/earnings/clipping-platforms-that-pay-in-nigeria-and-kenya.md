...
| **DareBay** | $1.00–$10.00 per 1,000 counted views, up to $500 per clip, nothing taken from the task budget, then 10% deducted inside the withdrawal request | USDT on the TON network only, no bank or mobile-money leg, no country list | request from 10 USDT | a settlement time: a person checks every request by hand |
