...
## A legitimate fee versus a scam request

The legitimate DareBay fee:

- is shown inside the form before confirmation;
- is 10% of the requested amount;
...
It is 10% of the requested amount. The exact calculation and amount to receive are shown before confirmation.
...
Contest credit and withdrawal are different operations. The reward is recorded on the available balance; a 10% fee is deducted from the amount requested for withdrawal.

### Do I pay the fee separately?

No. It is deducted inside the request. Never transfer money in advance to unlock a payout.
