...
<div class="docs-cover">
  <div class="docs-cover-eyebrow">Help</div>
  <h1 class="docs-cover-title">Questions,<br>straight answers.</h1>
  <p class="docs-cover-lede">No marketing fog. The things people ask before signing up, answered the way we would answer a friend.</p>
</div>
...
Question not covered here? Write to **support@darebay.com**. We read everything and we answer.
