...
description: "DareBay fees by operation: 0% to create, top up or enter a contest; 8% on a store purchase; 10% to withdraw a balance, from a 10 USDT request."
...
| Withdraw an available balance | 10% | Minimum request: 10 USDT; deducted inside the request |
