...
out.push('# from docs/content-pages.json via the strict registry — a declared hub is a hub')
...
out.push('# The retired /docs tree. Known historical addresses receive exact permanent')
out.push('# redirects from the container; unknown paths receive a real 404 rather than a')
out.push('# soft-404 redirect. The known redirects are kept indefinitely.')
